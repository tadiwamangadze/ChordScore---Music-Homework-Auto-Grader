		...
		<?php include"navbar.php";?><br>
			...
			<div id="section">
				...
				<div class="content">
						...
						<br><a style='color: #fefefe; text-decoration:none; border:#5ca08e 1px solid; border-radius:20px; padding:7px; background-color:#5ca08e; margin-left: 10px;' href='create_class.php'>Create New Class
							</a><br><br>
						<div class="tbox">
							<h3 style="margin-top:30px; font-size: 25px; margin-left: 10px;"> All Classes </h3>
							<?php
								if(isset($_GET["mes"]))
								{
								...
								<?php
									...
									if($res->num_rows>0)
									{
										...
										{	
											...
											echo "
												<tr>
													<td><a class='assignment_link' href='class_home.php?id={$r["class_id"]}'>{$r["class_name"]}</a>
